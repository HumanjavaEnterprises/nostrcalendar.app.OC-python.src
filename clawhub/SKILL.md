---
name: nostrcalendar
description: Nostr-native scheduling — manage availability, book meetings, negotiate schedules over Nostr relays
version: 0.2.4
metadata:
  openclaw:
    requires:
...
# NostrCalendar — Nostr-native scheduling
...
|----------|----------|-----------|-------------|
| `NOSTR_NSEC` | Yes | **Yes** | Nostr private key (bech32 `nsec1...` or hex) |
| `NOSTR_RELAY` | No | No | Relay URL for publishing and querying (default: operator-defined) |

## Understanding NIP-52 Calendar Events

Nostr defines calendar events in [NIP-52](https://github.com/nostr-protocol/nips/blob/master/52.md). Here is what that means in practice:
